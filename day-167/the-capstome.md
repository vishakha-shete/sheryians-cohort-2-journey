# because of missing out sessions i think i missed something most important thing that is the competition
...
- but in companies their your creating something that time nayone is available for explaining this things to you the answer is no 
- whenever your becoming a developer their is a one seniour deeloper come to you and he gives you some documentation like readme files and tell you to read this md file and set up the environment according to that their is a lot to read 
- developer is dont write only code developer is also reading lots of documentation how codes rund how it works and all this are things then reading this developer works as per the guidelines and requirement 
...
- it is sendbox microservise these spins containers for us and create a development invironment so this the sendbox services yess its not complete its short it grows while we are building 
